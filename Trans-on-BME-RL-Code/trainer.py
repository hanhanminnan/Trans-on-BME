...
class Trainer(object):
    ...
    def train(self):
        ...
        #     self.dqn.q_network.load_state_dict(torch.load(self.load_model, map_location=self.device))
        #     print("The model have been loaded sucessfully!")
        while episode <= self.max_episodes:
            ...
            for step_num in range(self.steps_per_episode):
                ...
                self.logger.log("step{} score:{}\n".format(acc_steps,score))
    ...
    def get_greedy_actions(self,obs_stack, doubleLearning):
